module.exports = {
  siteMetadata: {
    title: `Сайт компании Крона`,
    description: `Сайт по продаже пиломатериалов в Санкт-Петербурге и Ленинградской области`,
    author: `Timur SaltyRain Garipov`,
  },
  plugins: [
